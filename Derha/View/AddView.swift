...
struct AddView: View {
    ...
    @State private var unit = ["Kg", "ml", "l", "Peice"]
     ...
     VStack {
      ...
      HStack{
        ...
        label:{
         Image("barcodeButton")
          ...
          Spacer()
       CustomTextFieldForNumbers(isCorrect: $isQutEmpty, text: $viewModel.product.qy, placeHolder: "Ex: 20", titel: Text("Quantity"))
           .padding(.leading, 70)
      ...
      HStack{
        CustomTextField(isCorrect: $isUnitEmpty, text: $viewModel.product.unit, placeHolder: "Ex: 12Kg", titel: Text("Unit"))
          ...
          Spacer()
        CustomTextFieldForNumber(isCorrect: $isRemainEmpty, text: $viewModel.product.remainingQuantityAlert, placeHolder: "Ex: 10", titel: Text("Alert me when remaining quantity is"))
            .padding(.leading, 70)
            .keyboardType(.numberPad)
        } .padding() .padding(.horizontal, 65)
      ...
      HStack{
       CustomTextFieldForDate(date: $expdate, selectedDateText: $viewModel.product.expdate, placeHolder: "Ex: 20-02-2022", titel: Text("Expiration Date"), isCorrect: $isDateEmpty)
        .padding(.trailing, 70)
          Spacer()
       CustomTextFieldForNumbers(isCorrect: $isPriceEmpty, text: $viewModel.product.price, placeHolder: "Ex: 40 SAR", titel: Text("Price"))
        .padding(.leading, 70)
        .keyboardType(.numberPad)
      } .padding() .padding(.horizontal, 65)
